...
import backgroundImage from "../../imports/image-6.png";
import pantheonIcon from "../../imports/image-2.png";

export default function LayoutExhibit1() {
        ...
        <div className="relative w-[393px] h-[852px] bg-black rounded-[60px] shadow-2xl p-3">
          ...
          <div className="relative w-full h-full bg-white rounded-[48px] overflow-hidden">
            ...
            <div className="relative w-full h-full overflow-hidden">
              ...
              {/* Glass Taskbar */}
              <div className="absolute top-0 left-0 right-0 z-30 h-[100px] bg-black/40 backdrop-blur-md border-b border-white/30">
